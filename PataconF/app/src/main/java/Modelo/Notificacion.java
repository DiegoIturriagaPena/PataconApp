...
public class Notificacion implements Serializable, Comparable<Notificacion> {
    ...
    public Notificacion(String idViaje, int imagen,  String estado, String idChofer, String idProductor, String origen, String destino, String origenTexto, String destinoTexto, String ubicacionActual, String patente, int planned, String fecha, String hora) {
        this.idViaje = idViaje;
        this.imagen = imagen;
        this.idViaje = idViaje;
        this.estado = estado;
